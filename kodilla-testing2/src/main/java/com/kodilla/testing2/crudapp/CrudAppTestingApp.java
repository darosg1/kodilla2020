...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_CONTENT = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String [] args){
        ...
        driver.get("https://darosg1.github.io/");

        WebElement searchField = driver.findElement (By.xpath (XPATH_INPUT));
        searchField.sendKeys("Test IntellJ");

        WebElement textAreaField = driver.findElement (By.xpath (XPATH_CONTENT));
        textAreaField.sendKeys("Test IntelliJ content");
