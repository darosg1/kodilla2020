...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://darosg1.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("darosg1@yahoo.com");
        driverTrello.findElement (By.id("password")).sendKeys("quDbom-5pejhe-venkeq");
    ...
    public void deleteTestTaskCrud(String taskName) throws InterruptedException{
        ...
        driver.navigate().refresh();
        while(!driver.findElement(By.xpath(XPATH_DELETE)).isDisplayed());
